...
<title>Faceworld | Ad Setup 2</title>
<link href="css/ad-setup-2.css" rel="stylesheet" type="text/css" media="screen" />
...
<div id="wrapper">
  ...
  <div id="cube">
    <form action="ad-setup-3.php" method="post" enctype="multipart/form-data"> 
    <div id="rect_box">
      <div id="rect_passbox">
        <div id="forgot_titlebox">
          <div id="fortitlebx"><strong>Hyperlink to your site</strong></div>
        </div>
        <div id="forgot_box">
          <div id="c_forbox">
            <label>
              <input name="website" placeholder="E.g. http://" type="text" id="website" size="60" />
            </label>
          </div>
        </div>
        <div id="buttonrow">
          <div id="recover_button_bx"><input type="image" src="http://www.faceworld.io/img/finish_a.png" name="image" width="87" height="35"></div>
        </div>
      </div>
    </div>
     </form>
